...
#define VIVA_GET_ARGUMENT_TYPE_FOR_SCANF_IMPL(any_type_value_)                                                         \
	_Generic((any_type_value_),                                                                                          \
		void *: " %p",                                                                                                     \
		bool: " %d",                                                                                                       \
		char: " %c",                                                                                                       \
		signed char: " %hhd",                                                                                              \
...
#define VIVA_IS_CHAR_PTR_IMPL(any_type_value_) _Generic((any_type_value_), char *: true, default: false)

//! for any type except char *
#define VIVA_GET_FROM_STDIN_RAW_IMPL_1(any_type_value_)                                                                \
	({                                                                                                                   \
		typeof(any_type_value_) _any_type_value_;                                                                          \
		scanf(VIVA_GET_ARGUMENT_TYPE_FOR_SCANF_IMPL(any_type_value_), &_any_type_value_), _any_type_value_;                \
	})
//! for char *
...
#define VIVA_GET_FROM_STDIN_RECURSIVE_IMPL_2(any_type_value_, max_size_)                                               \
	VIVA_GET_FROM_STDIN_RECURSIVE_STRING_IMPL(any_type_value_, max_size_)
