...
struct VIVA_CONSOLE_SINGLETON viva_cstd_impl_terminal_save_console_buffer(struct VIVA_TERMINAL_INSTANCE *);
struct VIVA_CONSOLE_SINGLETON viva_cstd_impl_terminal_clear_console(const struct VIVA_TERMINAL_INSTANCE *);
struct VIVA_CONSOLE_SINGLETON viva_cstd_impl_terminal_restore_console_buffer(const struct VIVA_TERMINAL_INSTANCE *);
struct VIVA_CONSOLE_SINGLETON viva_cstd_impl_terminal_get_console_size(struct VIVA_TERMINAL_INSTANCE *);
struct VIVA_CONSOLE_SINGLETON viva_cstd_impl_terminal_init(struct VIVA_TERMINAL_INSTANCE *);
struct VIVA_CONSOLE_SINGLETON viva_cstd_impl_terminal_load(struct VIVA_TERMINAL_INSTANCE *);
...
inline struct VIVA_CONSOLE_SINGLETON viva_cstd_impl_terminal_init(struct VIVA_TERMINAL_INSTANCE *terminal) {
...
inline struct VIVA_CONSOLE_SINGLETON viva_cstd_impl_terminal_load(struct VIVA_TERMINAL_INSTANCE *terminal) {
	terminal->hConsole = GetStdHandle(STD_OUTPUT_HANDLE);
	terminal->buffer	 = nullptr;
	viva_cstd_impl_terminal_get_console_size(terminal);
	return Console;
}
inline struct VIVA_CONSOLE_SINGLETON viva_cstd_impl_terminal_get_console_size(struct VIVA_TERMINAL_INSTANCE *terminal) {
...
inline struct VIVA_CONSOLE_SINGLETON viva_cstd_impl_terminal_save_console_buffer(struct VIVA_TERMINAL_INSTANCE *terminal) {
	VIVA_RUNTIME_REQUIRE(terminal->hConsole != nullptr && (bool)("Invalid console handle"));
...
inline struct VIVA_CONSOLE_SINGLETON viva_cstd_impl_terminal_clear_console(const struct VIVA_TERMINAL_INSTANCE *terminal) {
	VIVA_RUNTIME_REQUIRE(terminal->hConsole != nullptr && (bool)("Invalid console handle"));
...
inline struct VIVA_CONSOLE_SINGLETON viva_cstd_impl_terminal_restore_console_buffer(const struct VIVA_TERMINAL_INSTANCE *terminal) {
	VIVA_RUNTIME_REQUIRE(terminal->hConsole != nullptr && (bool)("Invalid console handle"));
...
typedef struct VIVA_TERMINAL_INSTANCE Terminal;
// pop pack
