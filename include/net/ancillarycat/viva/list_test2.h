...
viva_result_t viva_cstd_impl_list_create(_In_ void* data);
 ...
 */
static _Ret_maybenull_ struct list_node* viva_cstd_impl_list_create_list_node_impl(_In_ void* data);
...
viva_result_t viva_cstd_impl_list_create_list_node(_In_ void* data);
 ...
 */
static viva_status_t viva_cstd_impl_list_push_front(_Inout_ struct list_header* const list_header, _In_ void* data);
 ...
 * @return Status of the operation.
 */
static viva_status_t viva_cstd_impl_list_push_back(_Inout_ struct list_header* const list_header, _In_ void* data);
 ...
 * @return Status of the operation.
 */
static viva_status_t viva_cstd_impl_list_insert_after(_In_ struct list_node* const node, _In_ void* data);
 ...
 * @return Status of the operation.
 */
static viva_status_t viva_cstd_impl_list_erase_if(_Inout_ struct list_header* const list_header, _In_ void* data);
...
inline viva_result_t viva_cstd_impl_list_create(void* data)
{
...
inline viva_status_t viva_cstd_impl_list_push_back(struct list_header* const list_header, void* data)
{
...
inline struct list_node* viva_cstd_impl_list_create_list_node_impl(void* data)
{
...
inline viva_result_t viva_cstd_impl_list_create_list_node(void* data)
{
...
inline viva_status_t viva_cstd_impl_list_push_front(struct list_header* const list_header, void* data)
{
...
inline viva_status_t viva_cstd_impl_list_insert_after(struct list_node* const node, void* data)
{
    if (node == nullptr)
        return kOutOfRange;
...
inline viva_status_t viva_cstd_impl_list_erase_if(struct list_header* const list_header, void* data)
{
    bool cnt = 0;
    if (list_header == nullptr)
        return kEmpty;
