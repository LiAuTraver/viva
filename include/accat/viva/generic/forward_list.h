...
static _Generic_usage bool viva_cstd_impl_forward_list_is_empty(_In_ void *header) viva_param_nonnull(1);

static _Generic_usage viva_status_t viva_cstd_impl_forward_list_drop(_In_ void *header) viva_param_nonnull(1);

static _Generic_usage viva_status_t viva_cstd_impl_forward_list_pop_front(_Inout_ void *header) viva_param_nonnull(1);
...
#define VIVA_CSTD_INSTANTIATE_FORWARD_LIST_OF_TYPE_IMPL(data_type_)                                                     \
	...
	static _Ret_maybe_result(struct viva_forward_list_node *)                                                             \
		_Ret_notnull_ viva_result_t viva_cstd_impl_forward_list_create_forward_list_node_of_##data_type_(                   \
			_In_ const data_type_ data);                                                                                      \
